...
def mainloop():
    def login():
        ...
        if int(userresult[0]) > 0:
            ...
            if int(passwordresult[0]) > 0:
                error.config(text="Successful Login",foreground="green")
            else:    
    ...
    appimage = Image.open("C:/Users/justi/OneDrive - student.newinti.edu.my/Progarming and algorithms/tdl.png")
